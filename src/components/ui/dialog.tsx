  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile-first width: full width minus padding, max on larger screens
        "w-[calc(100%-2rem)] max-w-lg",
        // Max height with scroll for long content
        "max-h-[85vh] overflow-y-auto",
        // Glass card styling for Kaeva
        "bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl",
        // Animations
